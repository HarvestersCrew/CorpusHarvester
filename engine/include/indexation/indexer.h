...
/**
 * Indexer class provides method to manage the indexation of the files in the database
*/
class Indexer {
...
public:
  ...
  */
   ...
   * @param drop_table if true, drop the tables existing in the database before creating the new ones
  */
  ...
  */
  ...
  /**
   * Filters the files in the database where the given attribute (one column in the database) has the given value
   * @param tagName the name of the tag
   * @param tagValue the value of the tag
   * return a list of all the files matching the condition
  */
