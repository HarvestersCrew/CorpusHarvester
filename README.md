...
### Full docker package
If you have Docker installed, just run `docker-compose -f docker-compose.demo.yml up` to have the full suite started. The web client is on the port `8081`. Afterhand, do not forget to run `docker-compose -f docker-compose.demo.yml down` to free the resources.
